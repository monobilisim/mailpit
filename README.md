...
- [API relaying](https://mailpit.axllent.org/docs/configuration/api-relay/) - forward messages via HTTP POST requests to a configurable API endpoint with support for various authentication methods
